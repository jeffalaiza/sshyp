...
$DB_user = 'sikatcft_kidlat';
$DB_pass = 'jan022011';
$DB_name = 'sikatcft_kidlat';
...
$location = '/home/cp970996/public_html/trash-mail.ml/kidlat/activevip.txt';
$fp = fopen($location, 'w');
...
WHERE ".$freeze." OR ".$vip_deactived ." AND ".$private_deactived." OR ".$is_activate." OR ".$status."
");
...
$location2 = '/home/cp970996/public_html/trash-mail.ml/kidlat/notactivevip.txt';
